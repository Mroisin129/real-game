...
export default function CreateTrivia() {
  ...
  async function saveInvite() {
    if (!title || !eventDate || !triviaQuestion || !triviaAnswer) {
      alert("Add a title, date, trivia question, and trivia answer.");
      return;
    }
    ...
    try {
      ...
      const inviteData = {
        ...
        triviaQuestion,
        triviaAnswer: triviaAnswer.trim(),
        createdAt: Date.now()
      };
      ...
      const docRef = await addDoc(collection(db, "triviaInvites"), inviteData);
      const link = `${window.location.origin}/trivia/${docRef.id}`;
      setShareLink(link);
    } catch (error) {
    ...
    <div className="page">
      <div className="container">
        <div className="hero hero-compact">
          <h1>Create a trivia invite</h1>
          <p>Build the invite, add a question, and share a link guests must answer to unlock.</p>
        </div>
        ...
        <div className="grid-layout create-editor-layout">
          <div className="card create-sidebar">
            <div className="create-section">
              ...
              <p className="meta create-section-meta">
                Customize the design, event details, and trivia unlock.
              </p>
            </div>
            ...
            <div className="field">
              <label className="label">Trivia unlock</label>
              ...
              <div className="meta">
                Guests must enter this answer correctly to unlock the invite.
              </div>
            </div>
          ...
          <div className="card create-preview-card">
            <div className="create-section">
              <h2>Live preview</h2>
              <p className="meta create-section-meta">
                This is the invite your guest will see after answering correctly.
              </p>
            </div>
